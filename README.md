...
This project analyses UK rail fare inflation data (ORR Table 7182) to explore how different passenger segments have been impacted by pricing strategies over the last 21 years.
...
### Key Findings
- Flexibility Premium: Anytime fares increased 26% more than Advance fares.
- Regional Disparity: Regional rail fares rose 10% more than London & SE.
- Real-Terms Increase: Rail fares outpaced RPI by 11.4 index points.
- Occasional Travellers Hit Hardest: Super Off Peak tickets saw the steepest increases.
...
## 🔄 Relationship to IJC437

This IJC445 project builds directly on work completed in IJC437:

| Aspect | IJC437 | IJC445 |
|--------|--------|--------|
| Focus | Exploratory data analysis | Advanced visualisation |
| Output | Statistical reports, trends | Composite visualisation |
